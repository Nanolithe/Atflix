...
class MoviesViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://api.themoviedb.org/3/movie/now_playing?api_key=66b3b8db2dcfbf7e4052b8ed947ca590")!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        Nuke.loadImage(with: URL(string: baseURL + movie.poster_path)!, into: cell.movieImageView)
        
        // Configure the cell with it's associated track
        cell.configure(with: movie)

        // return the cell for display in the t able view
        return cell
    }
