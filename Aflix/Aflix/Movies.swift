...
extension Movies{
    ...
    static var mockMovies: [Movies] = [
        Movies(title: "Black Panther: Wakanda Forever",
               poster_path:URL(string:"https://image.tmdb.org/t/p/w100/sv1xJUazXeYqALzczSZ3O6nkH75.jpg")!,
               overview:"Queen Ramonda, Shuri, M’Baku, Okoye and the Dora Milaje fight to protect their nation from intervening world powers in the wake of King T’Challa’s death.  As the Wakandans strive to embrace their next chapter, the heroes must band together with the help of War Dog Nakia and Everett Ross and forge a new path for the kingdom of Wakanda."),
        Movies(title: "Avatar: The Way of Water",
               poster_path:URL(string:"https://image.tmdb.org/t/p/w100/t6HIqrRAclMCA60NsSmeqe9RmNV.jpg")!,
               overview:"Set more than a decade after the events of the first film, learn the story of the Sully family (Jake, Neytiri, and their kids), the trouble that follows them, the lengths they go to keep each other safe, the battles they fight to stay alive, and the tragedies they endure."),
        Movies(title: "Ant-Man and the Wasp: Quantumania",
               poster_path:URL(string:"https://image.tmdb.org/t/p/w100/ngl2FKBlU4fhbdsrtdom9LVLBXw.jpg")!,
               overview:"Super-Hero partners Scott Lang and Hope van Dyne, along with with Hope's parents Janet van Dyne and Hank Pym, and Scott's daughter Cassie Lang, find themselves exploring the Quantum Realm, interacting with strange new creatures and embarking on an adventure that will push them beyond the limits of what they thought possible."),
        Movies(title: "Wolf Hound",
               poster_path:URL(string:"https://image.tmdb.org/t/p/w100/gHC0eFvXXNokP3sSNCTG2uks87R.jpg")!,
        ...
        Movies(title: "Devotion",
               poster_path:URL(string:"https://image.tmdb.org/t/p/w100/26yQPXymbWeCLKwcmyL8dRjAzth.jpg")!,
